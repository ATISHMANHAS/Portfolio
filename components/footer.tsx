      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="animate-fadeIn">
            <h3 className="text-xl font-semibold mb-4">Karanveer Singh</h3>
          ...
          <div className="animate-fadeIn" style={{ animationDelay: "400ms" }}>
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/ATISHMANHAS"
                target="_blank"
              ...
              <a
                href="mailto:atishmanhas9@gmail.com"
                className="text-muted-foreground hover:text-foreground transition-colors duration-300 transform hover:scale-110"
              >
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground">© {(new Date()).getFullYear()} Karanveer Singh. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
